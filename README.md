...
Tenho como objetivo atuar na área de desenvolvimento de jogos, unindo criatividade e programação para criar experiências interativas.

Atualmente, estou me preparando para ingressar no curso de Bacharelado em Inteligência Artificial pela Univesp, buscando desenvolver habilidades alinhadas às demandas do mercado e às novas tecnologias.

Mesmo antes de iniciar a graduação, mantenho uma rotina constante de estudos em programação e desenvolvimento de software, com foco em evolução contínua.

🚀 Aqui no meu GitHub, você encontrará projetos desenvolvidos durante meus estudos, incluindo trabalhos do curso técnico e projetos pessoais.
